...
public class LimbAmplification : MonoBehaviour
{
    ...
    [SerializeField] private float local_limbampfactor = 2.0f;
    ...
    void Update()
    {
        ...
        //Abhar's implementation of limb amp factor (for testing purposes)
        amplificationFactor = local_limbampfactor;
