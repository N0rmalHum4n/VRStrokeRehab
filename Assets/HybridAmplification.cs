...
public class HybridAmplification : MonoBehaviour
{   

    // This script was written originally by Ryan Sutton, as part of his dissertation.
    // I, Abhar Ozair Abdullah, made this copy, and have modified it to fit my games.
    // The original script is HybridAmplificationBehaviour.
    ...
    // formula : delta_uh = Constant_unhealthy * delta_actual_unhealthy_movement + Constant_healthy * delta_actual_healthy_movement

    [SerializeField] private float cUnhealthyAmpFactor = 1.0f;
    [SerializeField] private float cHealthyAmpFactor = 0.0f;
    [SerializeField] private bool snapTTRubberBand = false;
    [SerializeField] private bool smoothTTRubberBand = false;
    [SerializeField] private bool constantRubberBand = false;
    [SerializeField] private bool velocityRubberBand = false;
    [SerializeField] private bool velocityTimeRubberBand = false;
    [SerializeField] private float yOffset;
    [SerializeField] private HandVisualizer handVisualizer;
    [SerializeField] private float rubberBandSpeed;
    ...
    IEnumerator Start()
    {
        ...
        this.transform.position = unhealthyHandPosition.position + (c * unhealthyHandPosition.forward) + new Vector3(0f, yOffset, 0f);
        this.transform.rotation = unhealthyHandPosition.transform.rotation;
        // rotation offset testing
        this.transform.rotation = unhealthyHandPosition.rotation * Quaternion.Euler(45f, 0f, 0f);
    ...
    void smoothRubberBandMovement(Vector3 target, ref Vector3 ampMovement)
    {
        ...
        { // if = to stop overshooting
            ...
            // TODO: 1.2f can be a variable; --> ABHAR: "Done."

            float speed = MathF.Pow(rubberBandSpeed, distance) * Time.deltaTime; // speed is proportional to the square of the distance.
    ...
    void Update()
    {
        ...
        Vector3 ampMovement = cUnhealthyAmpFactor * unhealthymovement + cHealthyAmpFactor * healthymovement;
        ...
        if (snapTTRubberBand)
        {
            ...
            { // we have not moved outside of the threshold; Check time
        ...
        // the yOffset addition is to test prevention of jitter when overlapping with table
